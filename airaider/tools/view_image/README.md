...
- **AiRaider defaults:** screenshots default to
...
- **Skill:** screenshot workflow lives in `airaider/skills/tooling/agent_browser.md`.
- **Recovery:** vision-not-supported model rejections are auto-recovered
  via `airaider.core.sessions.strip_all_images_from_session`, invoked from
  `airaider/core/execution.py`.
