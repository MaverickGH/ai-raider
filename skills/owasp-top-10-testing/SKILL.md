...
Install and LLM setup: **penetration-testing-with-airaider**.
...
Remediate with **fix-security-vulnerabilities-with-airaider** and re-run to prove each exploit is closed. For ongoing coverage as the app changes, gate pull requests using **ci-security-scanning-with-airaider**.
