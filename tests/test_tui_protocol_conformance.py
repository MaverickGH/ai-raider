...
The wire protocol is declared twice — ``airaider/interface/tui/backend/protocol.py``
for the backend and ``airaider/interface/tui/internal/protocol/protocol.go`` for the
...
from airaider.interface.tui.backend.protocol import PROTOCOL_CAPABILITIES, PROTOCOL_VERSION
