...
from airaider.core.agents import AgentCoordinator, WaitKind
from airaider.core.execution import _start_child_runner, run_agent_loop
from airaider.core.hooks import BudgetExceededError, ReportUsageHooks
...
async def test_full_budget_lifecycle_reserve_then_cap(  # noqa: PLR0915
    ...
    with patch("airaider.core.hooks.get_global_report_state", return_value=ledger):
