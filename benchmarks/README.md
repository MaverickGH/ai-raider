...
We use security benchmarks to track AiRaider's capabilities and improvements over time. We plan to add more benchmarks, both existing ones and our own, to help the community evaluate and compare security agents.
...
AiRaider `v0.4.0` achieved a **96% success rate** (100/104 challenges) in black-box mode.
