...
description: "Configure AiRaider with Gemini models via Google Cloud"
---

## Installation

Vertex AI requires the Google Cloud dependency. Install AiRaider with the vertex extra:

```bash
pipx install "airaider-agent[vertex]"
```

## Setup

```bash
export AIRAIDER_LLM="vertex_ai/gemini-3-pro-preview"
```
