---
title: "Overview"
description: "Configure your AI model for AiRaider"
---

AiRaider uses [LiteLLM](https://docs.litellm.ai/docs/providers) for model compatibility, supporting 100+ LLM providers.
...
```bash
export AIRAIDER_LLM="ollama/llama4"
