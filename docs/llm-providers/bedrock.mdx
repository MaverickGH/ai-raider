---
title: "AWS Bedrock"
description: "Configure AiRaider with models via AWS Bedrock"
---

## Installation

Bedrock requires the AWS SDK dependency. Install AiRaider with the bedrock extra:

```bash
pipx install "airaider-agent[bedrock]"
```

## Setup

```bash
export AIRAIDER_LLM="bedrock/anthropic.claude-4-5-sonnet-20251022-v1:0"
```
