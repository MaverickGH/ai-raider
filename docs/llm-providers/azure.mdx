---
title: "Azure OpenAI"
description: "Configure AiRaider with OpenAI models via Azure"
---

## Setup

```bash
export AIRAIDER_LLM="azure/your-gpt5-deployment"
...
|----------|-------------|
| `AIRAIDER_LLM` | `azure/<your-deployment-name>` |
...
```bash
export AIRAIDER_LLM="azure/gpt-5.4-deployment"
