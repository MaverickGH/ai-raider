---
title: "Contributing"
description: "Contribute to AiRaider development"
---
...
Skills are specialized knowledge packages that enhance agent capabilities. They live in `airaider/skills/`
...
the sidecar as `airaider/bin/airaider-tui`, and assigns the current platform tag.
Frozen releases built by `scripts/build.sh` and `airaider.spec` also require the
sidecar.
...
- AiRaider version (`airaider --version`)
- LLM being used
...
<CardGroup cols={2}>
  <Card title="Discord" icon="discord" href="https://discord.gg/airaider-ai">
