---
title: "Agent Tools"
description: "How AiRaider agents interact with targets"
---

AiRaider agents use specialized tools to test your applications like a real penetration tester would.
